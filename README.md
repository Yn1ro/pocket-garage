...
* [ Логическая модель данных (Data Model)](docs/ru/requirements/data-model.md)

### 3. Architecture & Infrastructure (`/docs/ru/architecture`)
* [ Системная архитектура (C4 Model, Sequence & Kafka Events)](docs/ru/architecture/system-architecture.md)

---

##  Архитектурный стек системы
